...
const PRODUCT = {
  "repo": "genesys-contact-center-risk-board",
  "vendor": "Genesys",
  "title": "contact center risk board",
  "domain": "CX / Contact Center",
  "audience": "CX leaders, contact-center operators, support executives, and incident commanders",
  "problem": "Customer-contact risk is difficult to explain when queues, agent readiness, outage posture, and escalation signals are fragmented.",
  "workflow": "The product maps queue leakage, agent readiness, service outages, customer impact, and executive comms into one risk surface.",
  "business": "Leaders can prioritize where service quality, staffing, routing, and customer-trust remediation need investment.",
  "technical": "Synthetic contact-center lanes are scored deterministically and published as a static CX evidence packet.",
  "integration": "Genesys queues, agent states, routing rules, service incidents, SLAs, and escalation messages.",
  "keywords": [
    "Genesys",
    "contact center",
    "CX operations",
